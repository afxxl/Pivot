...
import { resetPasswordTemplate } from "../../shared/emailTemplates/resetUserPassword.template";
...
export class ForgotPasswordUseCase {
  ...
  async execute(
    ...
    let link = `https://${company.subdomain}.pivot.app/reset-password?token=${token}`;

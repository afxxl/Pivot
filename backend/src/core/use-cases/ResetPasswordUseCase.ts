...
import { passwordChangedTemplate } from "../../shared/emailTemplates/passwordChanged.template";
...
export class ResetPasswordUseCase {
  ...
  async execute(
    ...
    const { subject, html } = passwordChangedTemplate({
      ...
      loginLink: `https://${company.subdomain}.pivot.app/login`,
    ...
    return {
      response: {
        ...
        message:
          "Password reset successfully. You can now login with your new password.",
        redirectTo: `https://${company.subdomain}.pivot.app/login`,
      },
    };
  }
}

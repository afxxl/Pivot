              ...
              <div className="space-y-4">
                <Alert className="border-green-200 bg-green-50">
                  ...
                  <AlertDescription className="text-green-800">
                    ...
                    you will receive password reset instructions. Please check
                    your inbox.
                  </AlertDescription>
                </Alert>

                <div className="p-4 rounded-lg bg-gradient-to-br from-purple-50/50 to-blue-50/50 border border-purple-100/30">

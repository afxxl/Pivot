          ...
          <Card className="border border-purple-100/50 shadow-2xl shadow-purple-100/50 backdrop-blur-sm">
            <CardHeader className="space-y-2 pb-3 pt-4">
              ...
              <CardDescription className="text-center text-base text-muted-foreground">
                Start your journey with PIVOT today
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="space-y-3 p-4 rounded-lg bg-gradient-to-br from-purple-50/50 to-blue-50/50 border border-purple-100/30">
                ...
                <div className="space-y-3 p-4 rounded-lg bg-gradient-to-br from-blue-50/50 to-purple-50/50 border border-blue-100/30">
                  <div className="flex items-center gap-2 mb-2">
                ...
                <div className="flex items-start space-x-2 pt-2">
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <Link
                        to="/terms"
                        className="text-primary hover:text-purple-600 font-medium underline underline-offset-2"
                      >
                        Terms of Service
                      </Link>{" "}
                      and{" "}
